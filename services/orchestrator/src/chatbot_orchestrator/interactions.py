...
Purpose
Reproducible answers. Write the ops.interactions row with the corpus version, model and prompt
versions, confidence, level and flags, one ops.citations row per kept citation and one
ops.tool_calls row per tool call. The question is stored encrypted, see ARCHITECTURE.md section 8.
