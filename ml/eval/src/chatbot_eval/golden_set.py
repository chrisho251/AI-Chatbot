...
Purpose
Context recall needs reference answers, so the four RAGAs metrics run on this set at every candidate
corpus version, at every model promotion and nightly. The same items drive Appendix C testing,
level 1 remembering and understanding, level 2 applying and analyzing across sources, level 3
...
eval.test_cases table with lake.append_rows. SMEs review every item.
