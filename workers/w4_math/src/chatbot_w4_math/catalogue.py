...
t_test_two_sample, chi_square, odds_ratio, relative_risk, incidence_rate and dosage. Document the
variable names each one expects, W8 prompts show them to the model.
