...
embedding model, so unchanged pages keep their ids across corpus versions. section_path lists the
...
forces a full rebuild of the corpus.
...
from chatbot_contracts.corpus import Chunk, CleanPage
